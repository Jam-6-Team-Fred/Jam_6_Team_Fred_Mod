...
namespace Jam6
{
    public interface INewHorizons
    {
        ...
        /// <param name="persistentConditionRequired">Persistent condition required for this title screen to Close.</param>
        /// <param name="factRequired">Ship log fact required for this title screen to Close.</param>
